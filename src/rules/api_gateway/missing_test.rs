...
fn is_excluded_path(path: &Path) -> bool {
    ...
    // Models, migrations, tests, types directories
    if path_str.contains("src/models")
...
mod tests {
    ...
    #[test]
    fn test_excluded_src_models() {
        let violations = check_with_path("function define() {}", "src/models/user.js");
        assert!(violations.is_empty());
    }
